...
// export default function OpenTier2Account() {
...
//         <p>Required documents (2MB and below): Signature, Passport Photograph, Utility Bill (Last 3 months)</p>
//       </div>
//     </DefaultLayout>
//   );
// }
